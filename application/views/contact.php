...
<div id="header">
  ...
  <ul>
		...
		<li class="contact on"><?=anchor('/main/contact','Contact Us')?> </li>
  </ul>
 <h1></h1>
  </div>
</div>
...
<div id="details">
	<h2>Contact Us</h2>
          <ul>
            <li class="name"><strong>ExQuest Customer Support</strong></li>
            <li class="address">UP Alumni Engineers Centennial Hall<br />
              University of the Philippines - Diliman<br />
              Quezon City, Philippines<br />
              1101</li>
            <li class="email">exquest2012@gmail.com</li>
            <li class="phone">(+63) 905 208 XXXX</li>
          </ul>
</div>
<div id="contact">
  <form method="post" action="#" class="postit">
        <fieldset>
